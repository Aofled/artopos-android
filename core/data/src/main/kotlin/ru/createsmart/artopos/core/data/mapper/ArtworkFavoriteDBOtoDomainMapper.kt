...
fun ArtworkFavoriteDBO.toDomain(): Artwork {
    ...
    return Artwork(
        ...
        imageDimensions = imageDimensions, date = date ?: "",
        yearInt = yearInt, technique = technique, description = description,
        url = url, images = domainImages,

        isFavorite = true, // In the favorites table, all items are favorites

        provenance = null, creditLine = null, classification = null, culture = null,
